...
var import_editorjs_react_renderer2 = __toESM(require_index_min());
var config = {
  codeBox: {
    disableDefaultStyle: true
  }
};
var CustomCodeRenderer = ({ data, style: style2, classNames, config: config2 }) => {
  let content = null;
  if (typeof data === "string")
    content = data;
  else if (typeof data === "object" && data.text && typeof data.text === "string")
    content = data.text;
  return content ? /* @__PURE__ */ React.createElement("p", {
    style: style2,
...
var style = {
  codeBox: {
    container: { color: "red", backgroundColor: "green", width: "200px", height: "200px" },
    code: { color: "green" }
  }
};
function EditorjsReact(props) {
  return /* @__PURE__ */ React.createElement("section", {
    ...
    style,
    config
  }), /* @__PURE__ */ React.createElement(import_editorjs_react_renderer2.default, {
    data: JSON.parse(props.previousData)
  }));
}
...
//# sourceMappingURL=/build/routes/blog/$slug-OR4KNC47.js.map
