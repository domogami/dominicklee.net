...
function StartpageGridItem(props) {
  ...
  }, /* @__PURE__ */ React.createElement("h1", null, props.title), /* @__PURE__ */ React.createElement("ul", null, props.links.map(function(d, idx) {
...
function Index() {
  const sectionOne = [{ "name": "test", "link": "https://google.com" }];
  return /* @__PURE__ */ React.createElement("div", {
...
//# sourceMappingURL=/build/routes/startpage/index-GQDEZVS3.js.map
