...
var useDate = () => {
  ...
  const date2 = `${day}, ${today.getDate()} ${today.toLocaleDateString(locale, { month: "long" })}
...
function Startpage() {
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", {
    ...
    id: "date"
  }, date), /* @__PURE__ */ import_react.default.createElement(import_react_router_dom.Outlet, null));
}
export {
  Startpage as default
};
//# sourceMappingURL=/build/routes/startpage-T37OPD7Y.js.map
