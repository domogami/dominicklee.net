...
function ReactEditorJSClient(props) {
  const factory = import_react2.default.useCallback((config) => new ClientEditorCore(config), []);
  return import_react2.default.createElement(ReactEditorJS, Object.assign({ factory }, props));
}
var import_react2, import_editorjs, import_paragraph, ClientEditorCore;
...
function ReactEditorJS2(_a) {
  ...
  const memoizedHolder = import_react3.default.useRef(holder !== null && holder !== void 0 ? holder : `react-editor-js-${Date.now().toString(16)}`);
  const editorJS = import_react3.default.useRef(null);
  ...
  return children || import_react3.default.createElement("div", { id: memoizedHolder.current });
}
function ReactEditorJSServer(props) {
  const factory = import_react3.default.useCallback((config) => new ServerEditorCore(config), []);
  return import_react3.default.createElement(ReactEditorJS2, Object.assign({ factory }, props));
}
var import_react3, ServerEditorCore;
...
function AdminIndex() {
  ...
  }, /* @__PURE__ */ React.createElement(ClientOnly, null), /* @__PURE__ */ React.createElement("button", null, "Save Article"));
}
export {
 ...
 */
//# sourceMappingURL=/build/routes/admin/index-B64G3YKH.js.map
