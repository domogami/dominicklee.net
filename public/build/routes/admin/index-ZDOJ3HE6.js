...
function Editor() {
  return /* @__PURE__ */ import_react3.default.createElement(import_react3.default.Fragment, null, /* @__PURE__ */ import_react3.default.createElement(ReactEditorJS3, {
    defaultValue: {
      time: 1635603431943,
      blocks: [
        {
        ...
        },
        {
          ...
          type: "paragraph",
          data: {
            text: "We have been working on this project more than three years. Several large media projects help us to test and debug the Editor, to make it's core more stable. At the same time we significantly improved the API. Now, it can be used to create any plugin for any task. Hope you enjoy. \u{1F60F}"
          }
        },
        {
          id: "FF1iyF3VwN",
...
function useHydrated() {
  let [hydrated, setHydrated] = (0, import_react4.useState)(() => !hydrating);
  (0, import_react4.useEffect)(function hydrate() {
    hydrating = false;
    setHydrated(true);
  }, []);
  return hydrated;
...
// app/routes/admin/index.tsx
var ReactEditorJS4 = createReactEditorJS();
function AdminIndex() {
 ...
 */
//# sourceMappingURL=/build/routes/admin/index-ZDOJ3HE6.js.map
