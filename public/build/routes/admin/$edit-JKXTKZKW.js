...
function PostSlug() {
  ...
  const [savedData2, setSavedData] = (0, import_react2.useState)("This is a test");
  ...
  const handleSave = React.useCallback(async () => {
    const savedData3 = await editorCore.current.save();
    props.children.changeSave(savedData3);
    console.log(savedData3);
    console.log(props.saveOutput);
  }, []);
  return /* @__PURE__ */ React.createElement(Form, {
    ...
    htmlFor: "markdown"
  }, "Markdown:"), " ", (errors == null ? void 0 : errors.markdown) && /* @__PURE__ */ React.createElement("em", null, "Markdown is required"), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("button", {
    onClick: () => console.log(savedData2)
  }, "BUTT "), /* @__PURE__ */ React.createElement(ClientOnly, null, /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("button", {
    onClick: handleSave,
    type: "button"
  }, "Save Content (check console output)"), /* @__PURE__ */ React.createElement(ReactEditorJS, {
    onInitialize: handleInitialize,
    tools: EDITOR_JS_TOOLS,
    defaultValue: props.previousData
 ...
 */
//# sourceMappingURL=/build/routes/admin/$edit-JKXTKZKW.js.map
