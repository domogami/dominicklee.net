import {
  Editor
} from "/build/_shared/chunk-HG3P4QRM.js";
import {
  Form,
  useActionData,
  useLoaderData,
...
function PostSlug() {
  function saveData(editorjsData) {
    post2.editorjs = editorjsData;
  }
  let errors = useActionData();
  let transition = useTransition();
  let post2 = useLoaderData();
  return /* @__PURE__ */ React.createElement(Form, {
    ...
    defaultValue: post2.slug,
    id: "slugInput",
    type: "text",
    name: "slug"
  }))), /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("label", {
    htmlFor: "markdown"
  }, "Markdown:"), " ", (errors == null ? void 0 : errors.markdown) && /* @__PURE__ */ React.createElement("em", null, "Markdown is required"), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement(Editor, {
    data: post2.editorjs,
    save: this.saveData
  }), /* @__PURE__ */ React.createElement("textarea", {
    defaultValue: post2.markdown,
    name: "markdown",
    id: "",
    rows: 20,
    cols: 30
...
//# sourceMappingURL=/build/routes/admin/$edit-TB4AIAU4.js.map
