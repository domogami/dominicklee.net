import {
  ClientOnly
} from "/build/_shared/chunk-MIPCUOFX.js";
import {
  useLoaderData
      ...
      return function(e) {
        ...
        var s = function() {
          function e2(t2) {
            ...
            !function(e3, t3) {
              if (!(e3 instanceof t3))
                throw new TypeError("Cannot call a class as a function");
            }(this, e2), this._elements = { wrapper: null }, this.api = i2, this.readOnly = a2, this.settings = [{ name: "unordered", title: this.api.i18n.t("Unordered"), icon: '<svg width="17" height="13" viewBox="0 0 17 13" xmlns="http://www.w3.org/2000/svg"> <path d="M5.625 4.85h9.25a1.125 1.125 0 0 1 0 2.25h-9.25a1.125 1.125 0 0 1 0-2.25zm0-4.85h9.25a1.125 1.125 0 0 1 0 2.25h-9.25a1.125 1.125 0 0 1 0-2.25zm0 9.85h9.25a1.125 1.125 0 0 1 0 2.25h-9.25a1.125 1.125 0 0 1 0-2.25zm-4.5-5a1.125 1.125 0 1 1 0 2.25 1.125 1.125 0 0 1 0-2.25zm0-4.85a1.125 1.125 0 1 1 0 2.25 1.125 1.125 0 0 1 0-2.25zm0 9.85a1.125 1.125 0 1 1 0 2.25 1.125 1.125 0 0 1 0-2.25z"/></svg>', default: r2.defaultStyle === "unordered" || false }, { name: "ordered", title: this.api.i18n.t("Ordered"), icon: '<svg width="17" height="13" viewBox="0 0 17 13" xmlns="http://www.w3.org/2000/svg"><path d="M5.819 4.607h9.362a1.069 1.069 0 0 1 0 2.138H5.82a1.069 1.069 0 1 1 0-2.138zm0-4.607h9.362a1.069 1.069 0 0 1 0 2.138H5.82a1.069 1.069 0 1 1 0-2.138zm0 9.357h9.362a1.069 1.069 0 0 1 0 2.138H5.82a1.069 1.069 0 0 1 0-2.137zM1.468 4.155V1.33c-.554.404-.926.606-1.118.606a.338.338 0 0 1-.244-.104A.327.327 0 0 1 0 1.59c0-.107.035-.184.105-.234.07-.05.192-.114.369-.192.264-.118.475-.243.633-.373.158-.13.298-.276.42-.438a3.94 3.94 0 0 1 .238-.298C1.802.019 1.872 0 1.975 0c.115 0 .208.042.277.127.07.085.105.202.105.351v3.556c0 .416-.15.624-.448.624a.421.421 0 0 1-.32-.127c-.08-.085-.121-.21-.121-.376zm-.283 6.664h1.572c.156 0 .275.03.358.091a.294.294 0 0 1 .123.25.323.323 0 0 1-.098.238c-.065.065-.164.097-.296.097H.629a.494.494 0 0 1-.353-.119.372.372 0 0 1-.126-.28c0-.068.027-.16.081-.273a.977.977 0 0 1 .178-.268c.267-.264.507-.49.722-.678.215-.188.368-.312.46-.371.165-.11.302-.222.412-.334.109-.112.192-.226.25-.344a.786.786 0 0 0 .085-.345.6.6 0 0 0-.341-.553.75.75 0 0 0-.345-.08c-.263 0-.47.11-.62.329-.02.029-.054.107-.101.235a.966.966 0 0 1-.16.295c-.059.069-.145.103-.26.103a.348.348 0 0 1-.25-.094.34.34 0 0 1-.099-.258c0-.132.031-.27.093-.413.063-.143.155-.273.279-.39.123-.116.28-.21.47-.282.189-.072.411-.107.666-.107.307 0 .569.045.786.137a1.182 1.182 0 0 1 .618.623 1.18 1.18 0 0 1-.096 1.083 2.03 2.03 0 0 1-.378.457c-.128.11-.344.282-.646.517-.302.235-.509.417-.621.547a1.637 1.637 0 0 0-.148.187z"/></svg>', default: r2.defaultStyle === "ordered" || true }], this._data = { style: this.settings.find(function(e3) {
          ...
          return o(e2, null, [{ key: "isReadOnlySupported", get: function() {
            ...
            var t2, n2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, i2 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, a2 = document.createElement(e3);
        ...
        function c(e2, t2) {
          for (var n2 = {}, r2 = [], i2 = 0; i2 < e2.length; i2++) {
            ...
            d2 !== -1 ? (o[d2].references++, o[d2].updater(f2)) : o.push({ identifier: u2, updater: v(f2, t2), references: 1 }), r2.push(u2);
          }
          return r2;
        }
        function l(e2) {
...
var require_bundle3 = __commonJS({
  "node_modules/@editorjs/image/dist/bundle.js"(exports, module) {
    init_react();
    !function(t, e) {
      typeof exports == "object" && typeof module == "object" ? module.exports = e() : typeof define == "function" && define.amd ? define([], e) : typeof exports == "object" ? exports.ImageTool = e() : t.ImageTool = e();
    }(window, function() {
      return function(t) {
        var e = {};
        function n(o) {
        ...
        window, t.exports = function(t2) {
          ...
          (function(t3) {
            ...
            function u(t4, e3) {
              for (; t4._state === 3; )
                t4 = t4._value;
              t4._state !== 0 ? (t4._handled = true, a._immediateFn(function() {
                var n3 = t4._state === 1 ? e3.onFulfilled : e3.onRejected;
                if (n3 !== null) {
                  var o2;
                  try {
                    o2 = n3(t4._value);
                  ...
                  (t4._state === 1 ? c : s)(e3.promise, t4._value);
            ...
            function l(t4) {
              t4._state === 2 && t4._deferreds.length === 0 && a._immediateFn(function() {
            ...
            function f(t4, e3, n3) {
              this.onFulfilled = typeof t4 == "function" ? t4 : null, this.onRejected = typeof e3 == "function" ? e3 : null, this.promise = n3;
            }
            function d(t4, e3) {
              var n3 = false;
              try {
            ...
            a.prototype.catch = function(t4) {
              ...
              return t4 && typeof t4 == "object" && t4.constructor === a ? t4 : new a(function(e3) {
                e3(t4);
              });
            ...
            }, a._immediateFn = typeof t3 == "function" && function(e3) {
              t3(e3);
            } || function(t4) {
              r(t4, 0);
          ...
          var r, i, a, u, c, s, l, f = n2(8), d = (i = function(t3) {
            ...
            var t3 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            if (t3.url && typeof t3.url != "string")
              throw new Error("Url must be a string");
            if (t3.url = t3.url || "", t3.method && typeof t3.method != "string")
              throw new Error("`method` must be a string or null");
            if (t3.method = t3.method ? t3.method.toUpperCase() : "GET", t3.headers && o(t3.headers) !== "object")
              throw new Error("`headers` must be an object or null");
            if (t3.headers = t3.headers || {}, t3.type && (typeof t3.type != "string" || !Object.values(r).includes(t3.type)))
              throw new Error("`type` must be taken from module's \xABcontentType\xBB library");
            if (t3.progress && typeof t3.progress != "function")
              throw new Error("`progress` must be a function or null");
            if (t3.progress = t3.progress || function(t4) {
            }, t3.beforeSend = t3.beforeSend || function(t4) {
            }, t3.ratio && typeof t3.ratio != "number")
              throw new Error("`ratio` must be a number");
            if (t3.ratio < 0 || t3.ratio > 100)
              throw new Error("`ratio` must be in a 0-100 interval");
            if (t3.ratio = t3.ratio || 90, t3.accept && typeof t3.accept != "string")
              throw new Error("`accept` must be a string with a list of allowed mime-types");
            if (t3.accept = t3.accept || "*/*", t3.multiple && typeof t3.multiple != "boolean")
              throw new Error("`multiple` must be a true or false");
            if (t3.multiple = t3.multiple || false, t3.fieldName && typeof t3.fieldName != "string")
          ...
          (function(t3) {
            var o = t3 !== void 0 && t3 || typeof self != "undefined" && self || window, r = Function.prototype.apply;
            function i(t4, e3) {
            ...
            }, n2(6), e2.setImmediate = typeof self != "undefined" && self.setImmediate || t3 !== void 0 && t3.setImmediate || this && this.setImmediate, e2.clearImmediate = typeof self != "undefined" && self.clearImmediate || t3 !== void 0 && t3.clearImmediate || this && this.clearImmediate;
          }).call(this, n2(0));
        }, function(t2, e2, n2) {
          (function(t3, e3) {
            !function(t4, n3) {
              ...
              if (!t4.setImmediate) {
                ...
                d = d && d.setTimeout ? d : t4, {}.toString.call(t4.process) === "[object process]" ? o = function(t5) {
                  ...
                  e4.source === t4 && typeof e4.data == "string" && e4.data.indexOf(a) === 0 && h(+e4.data.slice(a.length));
          ...
          !function() {
            try {
              n2 = typeof setTimeout == "function" ? setTimeout : i;
            } catch (t3) {
              n2 = i;
            }
            try {
          ...
          r.nextTick = function(t3) {
            ...
            s.push(new h(t3, e3)), s.length !== 1 || l || u(p);
          ...
          t2.exports = function() {
            ...
            return e3 = t3, (n3 = [{ key: "urlEncode", value: function(t4) {
              ...
              return Object.prototype.toString.call(t4) === "[object Object]";
          ...
          var n2 = function(t3) {
            ...
            return e3 = e3 || null, r = r || "&", i = i || null, t3 ? function(t4) {
              ...
              var u, c, s = a;
              if (i && (s = i + "[" + s + "]"), typeof t3[a] == "object" && t3[a] !== null)
                u = o(t3[a], null, r, s);
              else {
                e3 && (c = s, s = !isNaN(parseFloat(c)) && isFinite(c) ? e3 + Number(s) : s);
                var l = t3[a];
                l = (l = (l = (l = l === true ? "1" : l) === false ? "0" : l) === 0 ? "0" : l) || "", u = n2(s) + "=" + n2(l);
              }
              return u;
            })).join(r).replace(/[!'()*]/g, "") : "";
          };
        ...
        var o = function(t2) {
            ...
            return i2._invoke = function(t4, e4, n4) {
              ...
              return function(r3, i3) {
                ...
                for (n4.method = r3, n4.arg = i3; ; ) {
                  ...
                  l2.type === "throw" && (o4 = "completed", n4.method = "throw", n4.arg = l2.arg);
                }
              };
            }(t3, n3, a2), i2;
          }
          ...
          function b(t3, e3) {
            ...
            if (n3 === void 0) {
              if (e3.delegate = null, e3.method === "throw") {
                if (t3.iterator.return && (e3.method = "return", e3.arg = void 0, b(t3, e3), e3.method === "throw"))
                  return s;
                e3.method = "throw", e3.arg = new TypeError("The iterator does not provide a 'throw' method");
              }
              return s;
            ...
            var r2 = o3.arg;
            return r2 ? r2.done ? (e3[t3.resultName] = r2.value, e3.next = t3.nextLoc, e3.method !== "return" && (e3.method = "next", e3.arg = void 0), e3.delegate = null, s) : r2 : (e3.method = "throw", e3.arg = new TypeError("iterator result is not an object"), e3.delegate = null, s);
          }
          function w(t3) {
            var e3 = { tryLoc: t3[0] };
            1 in t3 && (e3.catchLoc = t3[1]), 2 in t3 && (e3.finallyLoc = t3[2], e3.afterLoc = t3[3]), this.tryEntries.push(e3);
          ...
          return f.prototype = g.constructor = d, d.constructor = f, d[a] = f.displayName = "GeneratorFunction", t2.isGeneratorFunction = function(t3) {
            ...
            if (t3.type === "throw")
              throw t3.arg;
            return t3.type === "break" || t3.type === "continue" ? this.next = t3.arg : t3.type === "return" ? (this.rval = this.arg = t3.arg, this.method = "return", this.next = "end") : t3.type === "normal" && e3 && (this.next = e3), s;
          }, finish: function(t3) {
            for (var e3 = this.tryEntries.length - 1; e3 >= 0; --e3) {
              var n3 = this.tryEntries[e3];
              if (n3.finallyLoc === t3)
            ...
            return this.delegate = { iterator: E(t3), resultName: e3, nextLoc: n3 }, this.method === "next" && (this.arg = void 0), s;
          } }, t2;
        }(t.exports);
        try {
          regeneratorRuntime = o;
        ...
        function c(t2, e2) {
          for (var n2 = {}, o2 = [], r2 = 0; r2 < t2.length; r2++) {
            ...
            f2 !== -1 ? (a[f2].references++, a[f2].updater(d2)) : a.push({ identifier: l2, updater: g(d2, e2), references: 1 }), o2.push(l2);
          }
          return o2;
        }
        function s(t2) {
        ...
        t.exports = function(t2, e2) {
          (e2 = e2 || {}).singleton || typeof e2.singleton == "boolean" || (e2.singleton = r());
          var n2 = c(t2 = t2 || [], e2);
          return function(t3) {
        ...
        var o = n(3), r = n.n(o), i = n(6), a = n.n(i), u = n(1), c = n.n(u), s = n(0), l = n.n(s), f = (n(15), n(7)), d = n.n(f), p = n(8), h = n.n(p), m = function() {
          ...
          return l()(t2, [{ key: "render", value: function(e2) {
            return e2.file && Object.keys(e2.file).length !== 0 ? this.toggleStatus(t2.status.UPLOADING) : this.toggleStatus(t2.status.EMPTY), this.nodes.wrapper;
            ...
            o2 === "VIDEO" && (r2.autoplay = true, r2.loop = true, r2.muted = true, r2.playsinline = true, i2 = "loadeddata"), this.nodes.imageEl = g(o2, this.CSS.imageEl, r2), this.nodes.imageEl.addEventListener(i2, function() {
          ...
          var e2, n2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, o2 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, r2 = document.createElement(t2);
          ...
          return l()(t2, [{ key: "uploadSelectedFile", value: function(t3) {
            ...
            (this.config.uploader && typeof this.config.uploader.uploadByFile == "function" ? L.a.selectFiles({ accept: this.config.types }).then(function(t4) {
              o2(t4[0]);
          ...
          return l()(t2, null, [{ key: "isReadOnlySupported", get: function() {
            ...
            return r.a.wrap(function(t4) {
              for (; ; )
                switch (t4.prev = t4.next) {
                  case 0:
                    t4.t0 = e3.type, t4.next = t4.t0 === "tag" ? 3 : t4.t0 === "pattern" ? 15 : t4.t0 === "file" ? 18 : 21;
                    break;
                  case 3:
            ...
            var n2 = this;
            this._data[t3] = e3, this.ui.applyTune(t3, e3), t3 === "stretched" && Promise.resolve().then(function() {
            ...
            this.image = t3.file, this._data.caption = t3.caption || "", this.ui.fillCaption(this._data.caption), E.tunes.forEach(function(n2) {
              var o2 = n2.name, r2 = t3[o2] !== void 0 && (t3[o2] === true || t3[o2] === "true");
              e3.setTune(o2, r2);
            });
          }, get: function() {
            return this._data;
...
var import_header = __toESM(require_bundle());
var import_list = __toESM(require_bundle2());
var import_image = __toESM(require_bundle3());
function Editor(props2) {
  let editorObject = useLoaderData(this.props);
  function startEditor() {
    try {
      var editor = new import_editorjs.default({
        holder: "editorjs",
        autofocus: true,
        tools: {
          header: {
  ...
  return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement("div", {
    ...
    onClick: startEditor
  }, "initialize editor"), /* @__PURE__ */ React2.createElement("button", {
    onClick: props2.save(editorSave())
  }, "Save Data"));
}
...
function AdminIndex() {
  ...
  }, /* @__PURE__ */ React.createElement(ClientOnly, null, () => /* @__PURE__ */ React.createElement(Editor, null)), /* @__PURE__ */ React.createElement("button", null, "Save Article"));
}
export {
 ...
 * },
 */
//# sourceMappingURL=/build/routes/admin/index-NA7W522M.js.map
