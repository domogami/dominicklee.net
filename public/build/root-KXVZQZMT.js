...
var ThemeProvider = ({ children }) => {
  const [theme2, setTheme2] = (0, import_react.useState)(initialThemeState.theme);
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (!!savedThemeLocal) {
      setTheme2(savedThemeLocal);
    }
  }, []);
  (0, import_react.useEffect)(() => {
    localStorage.setItem("globalTheme", theme2);
  }, [theme2]);
  return /* @__PURE__ */ import_react.default.createElement(ThemeContext_default.Provider, {
    value: { theme: theme2, setTheme: setTheme2 }
...
//# sourceMappingURL=/build/root-KXVZQZMT.js.map
