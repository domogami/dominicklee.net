...
var ThemeProvider = ({ props, children }) => {
...
function App() {
  ...
  return /* @__PURE__ */ import_react2.default.createElement("html", {
    ...
    className: `theme--${this.theme}`
  }, /* @__PURE__ */ import_react2.default.createElement(ThemeProvider_default, {
    theme: this.theme,
    setTheme: this.setTheme
  }, /* @__PURE__ */ import_react2.default.createElement(Outlet, null), /* @__PURE__ */ import_react2.default.createElement(ScrollRestoration, null), /* @__PURE__ */ import_react2.default.createElement(Scripts, null), /* @__PURE__ */ import_react2.default.createElement(LiveReload, null))));
}
export {
  App as default,
  meta
};
//# sourceMappingURL=/build/root-AMN6QK5D.js.map
